...
-- ============================================================
-- Test 1: decide for concrete steps
-- ============================================================
...
-- ============================================================
-- Test 2: tm_follow chaining for longer runs
-- ============================================================

theorem init_10 : run antihydra (initConfig 6) 10 =
    { state := some stE, left := [true, true, true], head := true,
      right := [false] } := by decide
